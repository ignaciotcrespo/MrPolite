 ...
 */
public class MockClassPublicSamePackage extends MockParentClassPublicSamePackage {
    ...
    MockClassDefaultSamePackage mMockClassDefaultSamePackage;
    ...
    public void assertValidData(int levelsTree) {
        ...
        assertThat(mMockClassDefaultSamePackage).isNotNull();
        assertThat(mInnerClass).isNotNull();
        assertThat(mInnerClassStatic).isNotNull();
        if (levelsTree > 1) {
            mMockClassDefaultSamePackage.assertValidData();
            mInnerClass.assertValidData();
            mInnerClassStatic.assertValidData();
        } else {
            mMockClassDefaultSamePackage.assertEmptyData();
