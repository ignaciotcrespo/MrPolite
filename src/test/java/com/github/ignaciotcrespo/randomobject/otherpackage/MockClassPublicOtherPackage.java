 ...
 */
public class MockClassPublicOtherPackage extends MockParentClassPublicOtherPackage {
    ...
    MockClassDefaultOtherPackage mMockClassDefaultOtherPackage;
